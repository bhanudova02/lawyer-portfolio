...
export function Carousel() {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden ">
            <div className="bg-gradient-to-b from-[#101212] to-[#08201D] relative h-full" >
                <section className="relative pt-12 pb-8 sm:pt-20 sm:pb-12 lg:pt-24 lg:pb-24 h-full flex flex-col justify-center">
                    <video src="/video.mp4" autoPlay loop muted className='w-full h-screen  object-cover absolute opacity-10 bottom-0' /> 
                    {/* <img src="/home_banner5.jpg" className='w-full h-screen  object-cover absolute opacity-10 bottom-0' /> */}
                    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="mt-4 text-sm text-white sm:text-base md:text-lg lg:text-xl">
                                With decades of experience, we offer expert legal services to protect your rights and secure your interests.
                            </p>
                            <a
                                href="#contact"
                                className="inline-flex items-center px-4 py-3 mt-6 font-semibold text-white transition-all duration-200 bg-green-500 rounded-lg sm:mt-8 sm:px-6 sm:py-4 md:px-8 md:py-5 md:text-base hover:bg-green-600 focus:bg-green-600"
                                role="button"
                            >
