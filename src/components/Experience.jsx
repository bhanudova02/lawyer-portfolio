    ...
    return (
        <div className="py-24">
            ...
            <div className="flex flex-col lg:flex-row">
                <div className="w-full lg:w-[40%] relative" data-aos="fade-right" data-aso-delay="300" >
                ...
                <div className="w-full lg:w-[60%] relative">
                    <div className="bg-white w-fit p-4 rounded-xl ms-0 lg:-ms-40 mt-4" >
                        <h2 className="text-3xl md:text-4xl font-bold text-teal-800" data-aos="fade-left">16 Years Experience</h2>
                    </div>
                    <div className="px-2 lg:px-6 mt-0 lg:mt-8">
                        <div>
                            <h6 className="font-semibold text-2xl"  data-aos="fade-left" data-aso-delay="200">Learn About Us</h6>
                            <h2 className="text-3xl md:text-5xl font-bold mt-1"  data-aos="fade-left" data-aso-delay="500">We Provide Reliable And Effective Legal Services</h2>
                            <p className="text-lg mt-4"  data-aos="fade-left" data-aso-delay="600">
